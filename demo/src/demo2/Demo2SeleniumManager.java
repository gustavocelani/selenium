 ...
 */
public class Demo2SeleniumManager {
    ...
    /**
     * Search parameter "text" in Google
    ...
    public void searchOnGoogle(String text) {
        ...
        // Click in "btnK" Google page HTML element
        mFirefoxWebDriver.findElement(By.name("btnK")).click();
    }
